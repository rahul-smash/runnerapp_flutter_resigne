    ...
    return SafeArea(
      child: Scaffold(
        appBar: BaseAppBar(
          ...
          title: Text('Payout Complete',style: TextStyle(color: Colors.white),),
          appBar: AppBar(
                      ...
                      child: Row(
                        children: [
                          ...
                          Align(
                            ...
                            child: Image.asset("lib/src/components/dashboard/images/top_header_tick.png",width: 50,height: 50,),
                          )
                        ],
                      ),
                    ),
                    Container(
                      margin: EdgeInsets.fromLTRB(Dimensions.getScaledSize(65), 10,
