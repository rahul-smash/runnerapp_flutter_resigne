...
class _ServicesLocationScreenState extends BaseState<ServicesLocationScreen> {
  ...
  void initState() {
    super.initState();
    saveLocationBloc.eventSink.add((LocationEventData(
        null, widget.loginResponse.data.id, LocationAction.SelectCity,
                            ...
                            child: Column(
                              ...
                              children: <Widget>[
                                Expanded(
                                  ...
                                  shrinkWrap: true,
                                  itemCount: SingletonServiceLocations.instance
                                      .serviceLocationResponse.data.length,
                                  itemBuilder: (context, index) {
                                    ServiceLocationData object =
                                        SingletonServiceLocations
                                            .instance
                                    ...
                                    return selectedCity != index
                                        ? ListTile(
                                            onTap: () {
                                              saveLocationBloc.eventSink.add(
                                                  (LocationEventData(
                                                      object.id,
                                                      widget.loginResponse.data
                                                          .id,
                                                      LocationAction.SelectCity,
                                                      selectedIndex: index)));
                                            },
                                            title: Container(
  ...
  validateAndSave({bool isSubmitPressed = false}) {
    ...
    ServiceLocationData object = SingletonServiceLocations
        .instance.serviceLocationResponse.data[selectedCity];
    saveLocationBloc.eventSink.add((LocationEventData(
        object.id, widget.loginResponse.data.id, LocationAction.SaveLocation)));
