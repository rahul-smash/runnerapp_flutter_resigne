...
import 'package:marketplace_service_provider/src/components/authentication/signUp/signup_screen.dart';
                ...
                child: Column(
                  children: <Widget>[
                    ...
                    TextFormField(
                      ...
                      validator: (val) =>
                          val.isEmpty ? labelMobileNumber : null,
                    ...
                    TextFormField(
                      ...
                      keyboardType: TextInputType.number,
                      validator: (val) =>
                      passwordCont.text.isEmpty ? labelErrorMPINNumber : null,
                      style: TextStyle(color: AppTheme.mainTextColor),
                      maxLength: 4,
                      decoration: InputDecoration(
                        hintText: hintMPIN,
