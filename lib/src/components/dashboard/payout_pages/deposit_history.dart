    ...
    return SafeArea(
      child: Scaffold(
        appBar: BaseAppBar(
          ...
          title: Text('Deposit History',style: TextStyle(color: Colors.white),),
          appBar: AppBar(
                                    ...
                                    children: [
                                      Positioned.fill(
                                        child: Align(
                                          ...
                                          child: Image.asset("lib/src/components/dashboard/images/tick_full_shade.png",
                                            width: Dimensions.getScaledSize(70),height: Dimensions.getScaledSize(70),),
                                        ),
                                      ),
                                      Container(
              ...
              Align(
                ...
                child: Column(
                  children: [
                    Container(
                      height: 40,
                      margin: EdgeInsets.fromLTRB(Dimensions.getScaledSize(65), 0, 40, 0),
                      child: Row(
                        children: [
                          Expanded(
                            child: Column(
                          ...
                          Image.asset("lib/src/components/dashboard/images/top_header_tick.png")
                        ],
                      ),
                    ),
                    Container(
