  ...
  Cart copyObject({
    dynamic item
      ...
      Cart(
        ...
        orderId: item.orderId ?? this.orderId,
        deviceId: item.deviceId ?? this.deviceId,
        deviceToken: item.deviceToken ?? this.deviceToken,
        platform: item.platform ?? this.platform,
        productId: item.productId ?? this.productId,
        productName: item.productName ?? this.productName,
        ...
        refundStatus: item.refundStatus ?? this.refundStatus,
        unitType: item.unitType ?? this.unitType,
        quantity: item.quantity ?? this.quantity,
        comment: item.comment ?? this.comment,
        isTaxEnable: item.isTaxEnable ?? this.isTaxEnable,
        hsnCode: item.hsnCode ?? this.hsnCode,
        gstDetail: item.gstDetail ?? this.gstDetail,
        cgst: item.cgst ?? this.cgst,
        sgst: item.sgst ?? this.sgst,
        igst: item.igst ?? this.igst,
        gstType: item.gstType ?? this.gstType,
        gstTaxRate: item.gstTaxRate ?? this.gstTaxRate,
        gstState: item.gstState ?? this.gstState,
        status: item.status ?? this.status,
        created: item.created ?? this.created,
        modified: item.modified ?? this.modified,
        image10080: item.image10080 ?? this.image10080,
        image300200: item.image300200 ?? this.image300200,
        image: item.image ?? this.image,
        variants: item.variants ?? this.variants,
      );
