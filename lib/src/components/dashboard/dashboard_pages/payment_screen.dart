...
class _PaymentScreenState extends BaseState<PaymentScreen> {
                                    ...
                                    child: InkWell(
                                      ...
                                      child: _createTopCard(
                                        ...
                                        '${isApiLoading ||
                                            ...
                                            ? '--'
                                            : payoutSummaryResponse.summery
                                            .pendingPayout.bookingCount}',
                                        labelPayoutPendingTitle,
                                        '${isApiLoading ||
                                            payoutSummaryResponse == null
                                            ? '--'
                                            : payoutSummaryResponse.summery
                                            .pendingPayout.bookingPayout}',
                                        '${isApiLoading ||
                                            payoutSummaryResponse == null
                                            ? '--'
                                            : payoutSummaryResponse.summery
                                            .pendingPayout.lastUpdated}',
                                      ),
                                    ),
                                  ),
                                  SizedBox(
                                    ...
                                    child: InkWell(
                                      ...
                                      child: _createTopCard(
                                        ...
                                        '${isApiLoading ||
                                            ...
                                            ? '--'
                                            : payoutSummaryResponse.summery
                                            .completedPayout.bookingCount}',
                                        labelReceivedPendingTitle,
                                        '${isApiLoading ||
                                            payoutSummaryResponse == null
                                            ? '--'
                                            : payoutSummaryResponse.summery
                                            .completedPayout.bookingPayout}',
                                        '${isApiLoading ||
                                            payoutSummaryResponse == null
                                            ? '--'
                                            : payoutSummaryResponse.summery
                                            .completedPayout.lastUpdated}',
                                      ),
                                    ),
                                  ),
                                ],
                              ...
                              child: InkWell(
                                onTap: () {
                                  Navigator.push(context,
                                      MaterialPageRoute(builder: (builder) =>DepositCashScreen()));
                                },
                                child: ClipRRect(
  ...
  void _openDepositHistoryScreen() {
    //TODO: handle this
    Navigator.push(context,
        MaterialPageRoute(builder: (builder) =>DepositHistory()));
  }

  Widget _createTopCard(Color cardBackgroundColor,
      String imageGraphic,
      String bookingCount,
      String labelTitle,
