...
class _BookOrderState extends State<BookOrder> with TickerProviderStateMixin {
                    ...
                    Container(
                      ...
                      child: TextField(
                          ...
                          decoration: new InputDecoration(
                              ...
                              fillColor: AppTheme.chipsBackgroundColor,
                              filled: true,
                              prefixIcon: Icon(
                                Icons.search,
                                color: AppTheme.textLightColor,
                    ...
                    child: Padding(
                      ...
                      child: InkWell(
                        ...
                        child: MaterialButton(
                            ...
                            minWidth: Dimensions.getWidth(percentage: 50),
                                ...
                                children: [
                                  ...
                                  Column(
                                    ...
                                    children: [
                                      ...
                                      Text(
                                        productList[index].title != null
                                            ? productList[index].title
                                            : "",
                                        overflow: TextOverflow.ellipsis,
                                      ),
                                      Visibility(
                                        // visible: productList[index].variants == null ,
                                        child: Padding(
                                          ...
                                          child: Container(
                                            ...
                                            child: Row(
                                              ...
                                              children: [
                                                Center(
                                                  child: Text(
                                                    productList[index].variants != null ? productList[index].variants[productList[index].selectedVariantIndex] != null ? productList[index].variants[productList[index].selectedVariantIndex].weight != null
                                        ...
                                        productList[index].variants != null
                                            ? productList[index]
                                                ...
                                                ? productList[index]
                                                            ...
                                                            .price !=
                                                        null
                                                    ? '${AppUtils.getCurrencyPrice(double.parse(productList[index].variants[productList[index].selectedVariantIndex].price.isNotEmpty ? productList[index].variants[productList[index].selectedVariantIndex].price : "0.00") ?? 0)}'
                                                    : "0"
                                                : "0"
                                            : "0",
                                      ),
    ...
    _categoryList = searchQuery.isEmpty
        ...
        : _categoryList != null
            ? _categoryList.where((SubCategory newtitle) {
                ...
                String _getName =
                    newtitle.title != null ? newtitle.title.toLowerCase() : "";
                print(_getName);
  ...
  void _getBestProducts() async {
    ...
    AppNetwork.getBestProducts(param, storeID: widget.storeId).then(
        (value) => _handleBestProductResponse(value),
        onError: (error) => _handleError(error));
  }
