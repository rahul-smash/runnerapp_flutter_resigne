...
class CategoryListRemoteDataSourceImpl extends DioBaseService
  ...
  Future<CategoryModel> getCategoryList(
      String locationId, String storeId) async {
    try {
      String queryParms = "/${locationId}";
      var response =
          await get(apiPath(storeId, _getCategories) + queryParms, null);
      CategoryModel categoryModel =
          CategoryModel.fromJson(jsonDecode(response));
  ...
  @override
  Future<CategoryServiceModel> getCategoriesServices(
    ...
    try {
      ...
      var response = await get(
          apiPath(StoreConfigurationSingleton.instance.configModel.storeId,
                  _getCategoryServices) +
              queryParms,
          null);
      CategoryServiceModel categoryModel =
          CategoryServiceModel.fromJson(jsonDecode(response));
      return categoryModel;
    } catch (e) {}
    return null;
  }
  ...
  @override
  Future<BaseResponse> saveCategories(
      String userId, List<int> selectedCategoryIdsList) async {
    try {
