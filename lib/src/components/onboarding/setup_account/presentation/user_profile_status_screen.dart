...
class UserProfileStatusScreen extends StatefulWidget {
  ...
  UserProfileStatusScreen(
      {this.isProfileApproved, this.userId, this.underApprovalModel});
  ...
  void initState() {
    ...
    if (widget.underApprovalModel != null) {
      ...
      getIt.get<AccountStepsDetailRepositoryImpl>()
          .getUnderApprovalDetail(widget.userId)
          .then((value) {
        underApprovalModel = value;
        isProfileApproved = underApprovalModel.success.userData.status == '1';
        setState(() {
          isLoading = false;
        });
      });
                    ...
                    children: [
                      ...
                      Container(
                        height: Dimensions.getHeight(
                            percentage: !isProfileApproved ? 23 : 35),
                        margin: EdgeInsets.only(
                            left: 30,
                            right: 30,
                            top: Dimensions.getHeight(percentage: 32)),
                        decoration: BoxDecoration(
                            boxShadow: shadow,
                      ...
                      Container(
                        margin: EdgeInsets.only(
                            ...
                            top: Dimensions.getHeight(
                                percentage: !isProfileApproved ? 58 : 68)),
                        child: Text(
                          "Your Categories",
                          style: TextStyle(
                              fontSize: Dimensions.getScaledSize(18),
                      ...
                      Container(
                        margin: EdgeInsets.only(
                            ...
                            right: 30,
                            top: Dimensions.getHeight(
                                percentage: !isProfileApproved ? 60 : 70)),
                        child: ListView.builder(
                          ...
                          itemBuilder: (context, index) {
                            Categoryy cat =
                                underApprovalModel.success.categoryies[index];
                            return Container(
