...
class _MyProfileScreenState extends BaseState<MyProfileScreen>
                        ...
                        child: Column(
                          ...
                          children: [
                              ...
                              children: [
                                Expanded(
                                  child: DropdownButtonFormField(
                                    ...
                                    items:
                                        _genderOptions.map((String category) {
                            ...
                            TextFormField(
                              ...
                              textInputAction: TextInputAction.next,
                              validator: (val) => val.isEmpty
                                  ? "Enter your Id Number(As on selected Id)"
                                  : null,
                              onFieldSubmitted: (value) {},
                              style: TextStyle(color: AppTheme.mainTextColor),
                              decoration: InputDecoration(
  ...
  showDocListview() {
    return ListView(
      ...
      children: <Widget>[
        Visibility(
          visible:
              _selectedImg1 != null || _selectedImg2 != null ? true : false,
          child: SizedBox(
            height: 20,
          ),
        ),
            ...
            child: ListTile(
              ...
              title: Text(
                  resultFileImgSize1 == null
                      ? ""
                      : profileInfoModel.data.identityProofImage1.isNotEmpty
                          ? "${profileInfoModel.data.identityProofImage1.split('/').last}"
              ...
              trailing: InkWell(
                ...
                child: Icon(
                  Icons.clear,
                  color:
                      widget.isComingFromAccount ? Colors.white : Colors.black,
                ),
              ),
            ...
            child: ListTile(
              ...
              title: Text(
                resultFileImgSize2 == null
                    ? ""
                    : profileInfoModel.data.identityProofImage2.isNotEmpty
                        ? "${profileInfoModel.data.identityProofImage2.split('/').last}"
                        : '${_selectedImg2.path.split('/').last}',
                maxLines: 2,
                overflow: TextOverflow.ellipsis,
              ),
              subtitle: Text(
                  resultFileImgSize2 == null ? "" : '${resultFileImgSize2}'),
              trailing: InkWell(
                onTap: () {
                  if (!widget.isComingFromAccount) {
                    setState(() {
  ...
  Future<void> callProfileApi({bool gotoProfileStepsScreen = false}) async {
    ...
    if (form.validate()) {
      ...
      if (profileInfoModel.data.identityProofImage1.isEmpty &&
          profileInfoModel.data.identityProofImage2.isEmpty) {
      ...
      BaseResponse baseresponse = await getIt
          ...
          .saveMyProfile(
              ...
              firstNameCont.text,
              lastNameCont.text,
              _selectedGenderUpOption,
              ageCont.text,
              mobileCont.text,
              emailCont.text,
              userCommentController.text,
              proofNameCont.text,
              idProofNameCont.text,
