...
class AccountStepsDetailRepositoryImpl extends DioBaseService
    implements AccountStepsDetailRepository {
  AccountStepsDetailRepositoryImpl() : super(AppNetworkConstants.baseUrl);

  static const _getAccountStepsDetail =
      '/runner_authentication/getAccountStepsDetail/';
  ...
  static const _saveBusinessDetail =
      '/runner_authentication/updateBusinessDetail';
  static const _getExperienceDetail =
      '/runner_authentication/getExperienceDetail/';
  static const _saveExperienceDetail =
      '/runner_authentication/updateExperienceDetail';
  static const _getAgreementDetail =
      '/runner_authentication/getAgreementDetail/';
  static const _updateAgreementDetail =
      '/runner_authentication/updateAgreementDetail';
  static const _submitForApproval = '/runner_authentication/submitForApproval';
  static const _getunderApprovalAccountDetail =
      '/runner_authentication/underApprovalAccountDetail/';
    ...
    try {
      ...
      var response = await get(
          apiPath(StoreConfigurationSingleton.instance.configModel.storeId,
                  _getAccountStepsDetail) +
              queryParms,
          null);
      AccountStepsDetailModel categoryModel =
          AccountStepsDetailModel.fromJson(jsonDecode(response));
    ...
    try {
      ...
      var response = await get(
          apiPath(StoreConfigurationSingleton.instance.configModel.storeId,
              ...
              queryParms,
          null);
      ProfileInfoModel categoryModel =
          ProfileInfoModel.fromJson(jsonDecode(response));
      return categoryModel;
    } catch (e) {}
    return null;
  }
  ...
  @override
  Future<BaseResponse> saveMyProfile(
      File selectedProfileImg,
      String firstNameCont,
      String lastName,
      String selectedGenderUpOption,
      String dob,
      String mobile,
      String email,
      String comments,
      String proofNameCont,
      String idProofNumberCont,
      String selectedProofTypeTag,
      {File selectedDocument1,
      File selectedDocument2,
      String user_id,
      profile_id,
      ProfileInfoModel profileInfoModel}) async {
    FormData formData;
    Map<String, dynamic> param =
        getIt.get<CommonNetworkUtils>().getDeviceParams();
    try {
      String profileFileName = selectedProfileImg == null
          ? ""
          : selectedProfileImg.path.split('/').last;
      String doc1FileName = selectedDocument1 == null
          ? ""
          : selectedDocument1.path.isEmpty
              ? ""
              : selectedDocument1.path.split('/').last;
      String doc2FileName = selectedDocument2 == null
          ? ""
          : selectedDocument2.path.isEmpty
              ? ""
              : selectedDocument2.path.split('/').last;
      formData = FormData.fromMap({
        ...
        "identity_proof_image1": selectedDocument1 == null
            ...
            : selectedDocument1.path.isEmpty
                ? ""
                : await MultipartFile.fromFile(
                    selectedDocument1.path,
                    filename: doc1FileName,
                  ),
        "identity_proof_image2": selectedDocument2 == null
            ? ""
            : await selectedDocument2.path.isEmpty
                ? ""
                : MultipartFile.fromFile(
                    selectedDocument2.path,
                    filename: doc2FileName,
                  ),
      });
    ...
    try {
      ...
      var response = await get(
          apiPath(StoreConfigurationSingleton.instance.configModel.storeId,
              ...
              queryParms,
          null);
      BusinessDetailModel categoryModel =
          BusinessDetailModel.fromJson(jsonDecode(response));
      return categoryModel;
    } catch (e) {}
    return null;
  }
  ...
  @override
  Future<BaseResponse> saveBusinessDetail(String userId,
      {String business_id,
      ...
      String radius,
      String service_type,
      String business_identity_proof,
      String business_identity_proof_number,
      File business_identity_proof_image,
      String working_id,
      String sun_open,
      String sun_close,
      String mon_open,
      ...
      String fri_close,
      String sat_open,
      String sat_close}) async {
    Map<String, dynamic> param =
        getIt.get<CommonNetworkUtils>().getDeviceParams();
    FormData formData;
    String docFileName = business_identity_proof_image == null
        ? ""
        : business_identity_proof_image.path.isEmpty
            ? ""
            : business_identity_proof_image.path.split('/').last;
    ...
    formData = FormData.fromMap({
      ...
      "business_identity_proof_image": business_identity_proof_image == null
          ...
          : business_identity_proof_image.path.isEmpty
              ? ""
              : await MultipartFile.fromFile(
                  business_identity_proof_image.path,
  ...
  Future<ExperienceDetailModel> getExperienceDetail(String userId) async {
    try {
      ...
      var response = await get(
          apiPath(StoreConfigurationSingleton.instance.configModel.storeId,
                  _getExperienceDetail) +
              queryParms,
          null);
      ExperienceDetailModel categoryModel =
          ExperienceDetailModel.fromJson(jsonDecode(response));
      return categoryModel;
    } catch (e) {}
    return null;
  }
  ...
  @override
  Future<BaseResponse> saveWorkDetail(
      {String userId,
      String experienceId,
      ...
      File workDoc2,
      File workDoc3,
      File certificateDoc1,
      File certificateDoc2,
    ...
    formData = FormData.fromMap({
      ...
      'work_photograph_image1': workDoc1 == null || workDoc1.path.isEmpty
          ...
          : await MultipartFile.fromFile(
              workDoc1.path,
              filename: workDoc1.path == null
                  ? ""
                  : workDoc1.path.isEmpty
                      ? ""
                      : workDoc1.path.split('/').last,
            ),
      'work_photograph_image2': workDoc2 == null || workDoc2.path.isEmpty
          ? ""
          : await MultipartFile.fromFile(
              workDoc2.path,
              filename: workDoc2.path == null
                  ? ""
                  : workDoc2.path.isEmpty
                      ? ""
                      : workDoc2.path.split('/').last,
            ),
      'work_photograph_image3': workDoc3 == null || workDoc3.path.isEmpty
          ? ""
          : await MultipartFile.fromFile(
              workDoc3.path,
              filename: workDoc3.path == null
                  ? ""
                  : workDoc3.path.isEmpty
                      ? ""
                      : workDoc3.path.split('/').last,
            ),
      'certificate_image1':
          certificateDoc1 == null || certificateDoc1.path.isEmpty
              ? ""
              : await MultipartFile.fromFile(
                  certificateDoc1.path,
                  filename: certificateDoc1.path == null
                      ? ""
                      : certificateDoc1.path.isEmpty
                          ? ""
                          : certificateDoc1.path.split('/').last,
                ),
      'certificate_image2':
          certificateDoc2 == null || certificateDoc2.path.isEmpty
              ? ""
              : await MultipartFile.fromFile(
                  certificateDoc2.path,
                  filename: certificateDoc2.path == null
                      ? ""
                      : certificateDoc2.path.isEmpty
                          ? ""
                          : certificateDoc2.path.split('/').last,
                ),
      'certificate_image3':
          certificateDoc3 == null || certificateDoc3.path.isEmpty
              ? ""
              : await MultipartFile.fromFile(
                  certificateDoc3.path,
                  filename: certificateDoc3.path == null
                      ? ""
                      : certificateDoc3.path.isEmpty
                          ? ""
                          : certificateDoc3.path.split('/').last,
                ),
    ...
    try {
      var response = await get(
          apiPath(StoreConfigurationSingleton.instance.configModel.storeId,
              _getAgreementDetail),
          null);
      AgreementDetailModel categoryModel =
          AgreementDetailModel.fromJson(jsonDecode(response));
      return categoryModel;
    } catch (e) {}
  }
    ...
    try {
      ...
      var response = await post(
          apiPath(StoreConfigurationSingleton.instance.configModel.storeId,
              _submitForApproval),
          param);
      UnderApprovalModel loginResponse =
          UnderApprovalModel.fromJson(jsonDecode(response));
      return loginResponse;
    } catch (e) {
      debugPrint(e.toString());
    }
  ...
  Future<UnderApprovalModel> getUnderApprovalDetail(String userId) async {
    try {
      var response = await get(
          apiPath(StoreConfigurationSingleton.instance.configModel.storeId,
                  _getunderApprovalAccountDetail) +
              userId,
          null);
      UnderApprovalModel categoryModel =
          UnderApprovalModel.fromJson(jsonDecode(response));
      return categoryModel;
    } catch (e) {}
  }
