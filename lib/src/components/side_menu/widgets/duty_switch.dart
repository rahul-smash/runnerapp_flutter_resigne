    ...
    return Container(
      ...
      child: Row(
        children: [
          ...
          Text("Duty",style: TextStyle(color: Colors.white,fontSize:Dimensions.getScaledSize(18),fontWeight: FontWeight.w600 ),),
          SizedBox(width: 10),
          CustomSwitch(
            value: isSwitched,
            ...
            onChanged: (value) async {
              ...
              this.dutyStatusObserver.changeStatus(baseresponse.newDuty.toString());
