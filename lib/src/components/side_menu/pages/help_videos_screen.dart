    ...
    return SafeArea(
      child: Scaffold(
        ...
        appBar: BaseAppBar(
          ...
          title: Text('How to Video',style: TextStyle(color: Colors.black),),
          appBar: AppBar(
          ...
          child: Column(
            children: [
              FutureBuilder<HelpVideosModel>(
                future: getIt.get<MenuOptionRepositoryImpl>().getHowToVideos(), // async work
                builder: (BuildContext context, AsyncSnapshot<HelpVideosModel> snapshot) {
                                        ...
                                        child: Row(
                                          ...
                                          children: [
                                                ...
                                                children: [
                                                  Expanded(
                                                      child: Column(
                                                        ...
                                                        mainAxisAlignment: MainAxisAlignment.center,
                                                        children: [
                                                          Text("${snapshot.data.data[index].title}",style: TextStyle(color: AppTheme.black,
                                                            fontSize: 18,fontWeight: FontWeight.w600,fontFamily: AppConstants.fontName,),),
                                                          SizedBox(height: 5,),
                                                          Text("${snapshot.data.data[index].videoUrl}",
                                                            style: TextStyle(color: Color(0xFF6DCEF9),fontSize: 14,
                                            ...
                                            IconButton(
                                              ...
                                              onPressed: (){
                                                AppUtils.share("${snapshot.data.data[index].title}\n${snapshot.data.data[index].videoUrl}",
                                                    subject:"${snapshot.data.data[index].title}");
                                              },
                                            ),
                                          ],
                                        )
